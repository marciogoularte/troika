###### Business Process Framework, Workflow Engine, Workflow Process, Open Source Workflow Engine, Business Process Management, Workflow Development, Workflow Monitoring, Java Workflow Engine, BPM, Workflow Engine Library, Java Workflow Development ######

---

> _Distributed business framework_
> ## WORKFLOW-engine  + RULE-engine + CEP-engine ##

> #### Build distributed workflows, execute million rules as a part of workflow process, make decisions and analysis through complex event processing ####


[Workflow\_Engine](Workflow_Engine.md) - Open Source Workflow Engine in java


---

[Complex\_Event\_Processing\_Engine](Complex_Event_Processing_Engine.md) - Open Source Complex Event Engine (CEP engine) in java

---

[Rule\_Engine](Rule_Engine.md) - Open Source Rule Engine in java
